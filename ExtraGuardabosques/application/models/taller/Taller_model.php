...
//			die(print_r($this->session->userdata))		;
			$where="";			
			$sql='
				select interno.ID__CVETALLER,VCH_TALLER,ID_Resultado_Evaluacion,FEC_FECHA,interno.ID__GUARDABOSQUE,NUM_PAGADO from
				(
					select ID__CVETALLER,VCH_TALLER,ID__GUARDABOSQUE,NUM_PAGADO from 
					...
					left join'; 
						...
						$sql.=' 
								(
									SELECT ID__ASISTENTE,ID__CLAVETALLER,ID__GUARDABOSQUE,NUM_PAGADO FROM catconf_061_asistentestalleres where ID__GUARDABOSQUE in (
