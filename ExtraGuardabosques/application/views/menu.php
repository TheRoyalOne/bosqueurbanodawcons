        ...
        <ul class="nav navbar-nav side-nav">
            <li>
                ...
                <ul id="subMenuRegistrp" class="collapse">
                    <li>
                        <a href="<?=base_url().'index.php/Arboles/ReportarPropios'?>"><i class="fa fa-dot-circle-o"></i> Mis Arboles</a>
                    </li>                   
                    <li>
                        <a href="<?=base_url().'index.php/Arboles/ReportarAjenos'?>"><i class="fa fa-dot-circle-o"></i>Otros Arboles</a>
                    </li>                    
                    <li>
                        <a href="<?=base_url().'index.php/Arboles/Consultar'?>"><i class="fa fa-dot-circle-o"></i>Consultar puntos</a>
                    </li>                    

                </ul>
            </li>                                
             <li>
                <a href="javascript:;" data-toggle="collapse" data-target="#subMenuTaller"><i class="fa fa-sliders"></i> Talleres <i class="fa fa-fw fa-caret-down"></i></a>
                <ul id="subMenuTaller" class="collapse">
                    <li>
                        <a href="<?=base_url().'index.php/taller/EvaluarLista'?>"><i class="fa fa-dot-circle-o"></i> Evaluar Taller</a>
                    </li>                   
                     <li>
                        <a href="<?=base_url().'index.php/taller/Inscribirse'?>"><i class="fa fa-dot-circle-o"></i> Inscribirse a Taller</a>
                    </li>                    
            ...
            <li>
                ...
                <ul id="subMenuTallers" class="collapse">
                    <li>
                        <a href="<?=base_url().'index.php/Preguntas/FAQ'?>"><i class="fa fa-dot-circle-o"></i> Preguntas Frecuentes</a>
                    </li>                   
                     <li>
                        <a href="<?=base_url().'index.php/Preguntas/MisPreguntas'?>"><i class="fa fa-dot-circle-o"></i> Mis preguntas</a>
                    </li>                    
