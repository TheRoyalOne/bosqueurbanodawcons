...
<div class="row form-horizontal">
	<div class="col-lg-8 col-md-8 col-sm-8">
		<div class="form-group">
          <label class="control-label col-lg-4 col-md-4 col-sm-4">Buscar por QR:</label>
          <div class="col-lg-8 col-md-8 col-sm-7">
            <input type="text" class="form-control" id="BusquedaQr" maxlength="2000">
          </div>
      	</div>      	
	</div>
	<div class="col-lg-2 text-left">
       	<button class="btn btn-primary" onclick="Busqueda()">Enviar</button>
    </div>
</div>
<div class="row form-horizontal">	
			...
			<div class="row form-horizontal">
					<div class="col-lg-12 col-md-12 col-sm-12">
					  ...
					  <div class="form-group">
						...
						<div class="col-lg-6">
						  <input type="file" class="form-control" name="VCH_RUTA_FOTO_SOLOETIQUETA" id="VCH_RUTA_FOTO_SOLOETIQUETA" accept="image/x-png,image/gif,image/jpeg">
						</div>
					  </div>
...
<script type="text/javascript" src="<?=base_url()?>js/Arboles/ReportarAjenos.js"></script>
