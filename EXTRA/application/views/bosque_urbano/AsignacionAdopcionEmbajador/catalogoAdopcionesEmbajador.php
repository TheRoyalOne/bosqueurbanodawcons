<div class="row form-horizontal">
    ...
    <div class="col-lg-2">
     ...
     <div class="row">
	  <div class="col-lg-offset-1 col-lg-10">
	   ...
	   $datos=array('ID Adopción','Codigo QR','Celular','Evento Adopción','GuardaBosque','Especie','Tamaño','Edad','Cantidad de Arboles',
	     'ID Adopción','Codigo QR','Celular','Evento Adopción','GuardaBosque','Especie','Tamaño','Edad','Cantidad de Arboles',
	     'ID Adopción','Codigo QR','Celular','Evento Adopción','GuardaBosque','Especie','Tamaño','Edad','Cantidad de Arboles',
	     'ID Adopción','Codigo QR','Celular','Evento Adopción','GuardaBosque','Especie','Tamaño','Edad','Cantidad de Arboles',
	     'ID Adopción','Codigo QR','Celular','Evento Adopción','GuardaBosque','Especie','Tamaño','Edad','Cantidad de Arboles',
	     'ID Adopción','Codigo QR','Celular','Evento Adopción','GuardaBosque','Especie','Tamaño','Edad','Cantidad de Arboles',
	...
	$this->table->set_heading('ID Adopción','Codigo QR','Celular','Evento Adopción','GuardaBosque','Especie','Tamaño','Edad','Cantidad de Arboles');
	...
	<div class="row">
	  <div class="col-lg-offset-1 col-lg-10">
	   ...
	   $datos=array('Embajador','Id Adopción','Campaña','GuardaBosques','Especie','Cantidad','',
	     'Embajador','Id Adopción','Campaña','GuardaBosques','Especie','Cantidad','',
	     'Embajador','Id Adopción','Campaña','GuardaBosques','Especie','Cantidad','',
	     'Embajador','Id Adopción','Campaña','GuardaBosques','Especie','Cantidad','',
	     'Embajador','Id Adopción','Campaña','GuardaBosques','Especie','Cantidad','',
	     'Embajador','Id Adopción','Campaña','GuardaBosques','Especie','Cantidad','',
	...
	$template= array('table_open'=>"<table data-toggle='table' data-align='center' data-halign='center' data-classes='table table-hover table-no-bordered' data-height='500' >",
	 'thead_open'=>"<thead style='background-color:#00A89C; color:#fff;' >");
	$this->table->set_template($template);
	$this->table->set_heading('Embajador','Id Adopción','Campaña','GuardaBosques','Especie','Cantidad','');
