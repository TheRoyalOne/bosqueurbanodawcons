<div id="page-wrapper">
  <div class="container-fluid">
	<div class="page-wrapper">
		...
		<div id="ReportarReforesta" class="modal fade" role="dialog">
			<!--<form id="formReportar" action="<?=site_url(array('bosqueUrbano', 'ReportarReforesta'))?>" method="post" >-->
			 <div class="modal-dialog modal-md">
				<div class="modal-content">
				  <div class="modal-header">
					<h4 class="modal-title">Reportar Reforestacion</h4>
				  </div>
				  <div class="modal-body">
					<div class="row form-horizontal">
						<div class="col-lg-12">
							<div class="form-group">
								  ...
								  <div class="col-md-8">
									 <select class="form-control requiredREFOR" id="ID__ESPECIERefor" name="ID__ESPECIERefor">
										 <option value="0">---</option>
									 </select> 								  
								 </div>
						   </div>
							<div class="form-group">
								  <label class="control-label col-md-3">Vivos:</label>
								  <div class="col-md-8">
									<input type="number" min="0" class="form-control requiredREFOR" id="NUM_VIVOS" name="NUM_VIVOS" >
									
								 </div>
						   </div>
							<div class="form-group">
								  <label class="control-label col-md-3">Sanos:</label>
								  <div class="col-md-8">
									<input type="number" min="0" class="form-control requiredREFOR" id="NUM_SANOS" name="NUM_SANOS" >									
								 </div>
						   </div>							
						</div>						
					</div>						
				  ...
				  <div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
					<button type="button" class="btn btn-primary" onclick="guardarSeguimientoReforesta()">Guardar Seguimiento</button>
				  </div>
				</div>
			  </div>
		    <!--</form>-->
...
<script type="text/javascript" src="<?=base_url()?>js/bosque_urbano/EventosREFOR.js"></script>
