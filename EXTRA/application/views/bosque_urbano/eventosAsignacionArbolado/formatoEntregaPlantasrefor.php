...
//						die(print_r($relarbolasignados));
						...
						<tr>
							...
							<td style="border:1px solid #ccc!important" align="center"><?
							if(!empty($relarbolasignado["contenedor_nombre"]))
							{
								echo $relarbolasignado["contenedor_nombre"];
							}
							?>
...
//						die(print_r($relarbolasignados));
			...
			<tr>
				<td colspan="2" align="center" style="color:#9ABB84">Horario de entregas 8:00 a 14:00 - Las solicitudes tienen que estar autorizadas por dirección o jefe de vivero.
				</td>
			</tr>
