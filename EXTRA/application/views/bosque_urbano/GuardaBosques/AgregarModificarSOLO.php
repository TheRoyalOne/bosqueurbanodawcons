<div class="row form-horizontal">
  <div class="col-lg-4 col-md-4 col-sm-4 col-sm-offset-1 col-md-offset-1 col-lg-offset-1">
    ...
    <div class="form-group">
     ...
     <div class="col-lg-5 col-md-5 col-sm-5 col-sm-offset-1 col-md-offset-1 col-lg-offset-1">
      <div class="form-group">
