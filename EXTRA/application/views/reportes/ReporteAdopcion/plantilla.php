		...
		<table width="100%">
			...
			<tr>
				<td  width="100%" align="center">
					  <table width="70%" border=0>						
						...
						<tr>
							<td width="50px">&nbsp;</td>
							<td class="bordersub"><?=fechahumana($dia["fecha"]);?></td>
							<td width="20px">
								<b><?=$dia["cant"]?></b>
							</td>	 
						</tr>
			...
			<tr>
				<td align="center">
					  <table width="70%" border=0>
						...
						$Cancelados=0;
						$Terminados=0;
						foreach($dataeventos["eventosPorEstatus"] as $estatus)
						{
							if($estatus["VCH_ESTATUS"]==1){$Activos=$estatus["cant"];}
							if($estatus["VCH_ESTATUS"]==2){$Terminados=$estatus["cant"];}
							if($estatus["VCH_ESTATUS"]==0){$Cancelados=$estatus["cant"];}

						}?>
						<tr>
							<td width="50px">&nbsp;</td>
							<td class="bordersub">Activos</td>
							<td width="20px">
								<b><?=$Activos?></b>
							</td>	 
						</tr>
						...
						<tr>
							<td width="50px">&nbsp;</td>
							<td class="bordersub">Cancelados</td>
							<td>
								<b><?=$Cancelados?></b>
							</td>	 
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
							<td class="bordersub">Terminados</td>
							<td>
								<b><?=$Terminados?></b>
							</td>	 
						</tr>						
					  ...
					  <table width="70%" border=0>
						<tr>
							<td align="left" colspan="2"  valign="bottom">
								<b>Eventos por Eficiencia</b>
							</td>						
							<td align="left" valign="bottom" >Llevado</td>
							<td align="left" valign="bottom" >Entregado</td>
							<td align="left" valign="bottom" >Sobrante</td>
							<td align="left" valign="bottom" >Eficiencia</td>
						</tr>
						<?php
						...
						$Eficiencia=0;
						$totales=0;
						foreach($dataeventos["eventosPorEficiencia"] as $ev)
						{

							$llevados=$llevados+$ev["llevados"];
							$entregados=$entregados+$ev["entregados"];
							$sobrante=$sobrante+($ev["llevados"]-$ev["entregados"]);
							$Eficiencia=$Eficiencia+(intval($ev["entregados"])/$ev["llevados"])*100;
							$totales++;
						?>
						<tr>
							<td width="50px">&nbsp;</td>
							<td><?=$ev["VCH_NOMBREEVENTO"]?></td>
							<td>
								<b><?=$ev["llevados"]?></b>
							</td>	 
							<td>
							...
							<td>
								<b><?=$ev["llevados"]-$ev["entregados"]?></b>
							</td>	 
							<td>
								<b><?=round ((( intval($ev["entregados"])/$ev["llevados"])*100),2)?>%</b>
							</td>	 
						</tr>		
						<?php
						}
						?>	
							...
							<td align="left" valign="bottom" ><?= number_format($llevados)?></td>
							<td align="left" valign="bottom" ><?= number_format($entregados)?></td>
							<td align="left" valign="bottom" ><?= number_format($sobrante)?></td>
							<td align="left" valign="bottom" ><?=intval(($Eficiencia/$totales))?>%</td>
						</tr>
			...
			<tr>
				<td align="center">
					...
					<?php 
					/*$markers="";
					foreach($dataeventos["eventosUbicados"] as $ev)
					{
					
						$markers.="&markers=icon:http://localhost:88/extra/imagenes/cami%C3%B3n.png%7Cshadow:true%7C".$ev['VCH_LATITUD'].",".$ev['VCH_LONGITUD'];
					}*/
					//$markers=&markers=icon:http://maps.google.com/mapfiles/ms/icons/blue-dot.png%7Cshadow:true%7C20.7258269,-103.493952?>
					<!-- &markers=icon:http://localhost:88/extra/imagenes/cami%C3%B3n.png%7Cshadow:true%7C20.7258269,-103.493952 -->

					<!--<img width="600" src="https://maps.googleapis.com/maps/api/staticmap?center=guadalajara,+Jalisco&zoom=11&scale=false&size=600x300&maptype=roadmap&key=AIzaSyBhx7r1gfk_DfWKHYCPLQiSo3GfqlAzBHA&format=png&visual_refresh=true&markers=icon:http://maps.google.com/mapfiles/ms/icons/blue-dot.png%7Cshadow:true%7C20.7258269,-103.493952&markers=icon:http://maps.google.com/mapfiles/ms/icons/blue-dot.png%7Cshadow:true%7Cguadalajara,+Jalisco" alt="Google Map of guadalajara, Jalisco">-->
								
					<!--<img width="900" src="https://maps.googleapis.com/maps/api/staticmap?center=guadalajara,+Jalisco&zoom=11&scale=false&size=600x300&maptype=roadmap&key=AIzaSyBhx7r1gfk_DfWKHYCPLQiSo3GfqlAzBHA&format=png&visual_refresh=true<?=$markers?>" alt="Google Map of guadalajara, Jalisco">-->
			...
			<tr>
				<td align="center">
					  <table width="70%" border=1>
						<tr>
							<td align="left" colspan="2"  valign="bottom">
								<b>Eventos de adopcion - Eventos por dia</b>
							</td>						
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
			...
			<tr>
				<td align="center">
					  <table width="70%" border=1>
						<tr>
							<td align="left" colspan="2"  valign="bottom">
								<b>Eventos de adopcion - Eventos por patrocinador</b>
							</td>						
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
			...
			<tr>
				<td align="center">
					  <table width="70%" border=1>
						<tr>
							<td align="left" colspan="2"  valign="bottom">
								<b>Eventos de adopcion - Estado</b>
							</td>						
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
			...
			<tr>
				<td align="center">
					  <table width="70%" border=1>
						<tr>
							<td align="left" colspan="2"  valign="bottom">
								<b>Eventos de adopcion - Arbolado llevado & entregado</b>
							</td>						
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
							<td>
								...
								<div id="divArbolesTotales" style="margin-top: 25px">
			...
			<tr>
				<td align="center">
					  <table width="70%" border=1>
						<tr>
							<td align="left" colspan="2"  valign="bottom">
								<b>Total de Árboles</b>
							</td>						
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
							<td>
								<div id="graficaTotalArboles" style="height: 300px; width: 90%;">
										<label id="totalArboles" style=" display: block;text-align: center;"></label>	
								</div>
								<div>
									
								</div>
								<div id="legendGrafica" class="donut-legend"></div>
				...
				<td align="center">
					  <table width="70%" border=1>
						...
						<tr>
							<td width="50px">&nbsp;</td>
							<td>
								<div id="graficaBarrasArbolesTotales" style="height: 300px; width: 90%;"></div>
...
var totalArboles = 0;
var totalArbolesEntregados = 0;
chartContainer4.options.data.forEach(function(label, i) 
{

	totalArboles = totalArboles + label["llevados"];
	totalArbolesEntregados = totalArbolesEntregados + label["entregados"]
	var	elemento=''+
...
var elementoArbolesTotales = '' +
		'<div style="margin-left:5px"> '+
			'<div style="float:left;width:35%;overflow:hidden;"><label ><b>TOTALES</b></label></div><div >'+
			'<div style="width:15%;float:left;"><span style="width:20px;background-Color:'+chartContainer4.options.barColors[0]+';margin:5px;">&nbsp;&nbsp&nbsp</span>Entregados: '+ totalArbolesEntregados.toLocaleString('es-MX') +'</div>'+
			'<div><span style="width:20px;background-Color:'+chartContainer4.options.barColors[1]+';margin:5px;">&nbsp;&nbsp&nbsp</span>Llevados: '+totalArboles.toLocaleString('es-MX')+'</div>'+
		'</div></div>';
;

$('#divArbolesTotales').append(elementoArbolesTotales);

var graficaTotalArboles=Morris.Donut({
  element: 'graficaTotalArboles',
  data: [
    {label: "Regresados", value: totalArboles - totalArbolesEntregados},
    {label: "Entregados", value: totalArbolesEntregados},
  ], colors: [
        '#E87B2F','#4270C1','#A2A2A2', '#FABC00','#41DB1B','#1BDBC1','#DB1B1D','#DB1BD4','#505584','#808450','#D2E02A','#CCE02A','#4EE02A'
  ]
});
graficaTotalArboles.options.data.forEach(function(label, i) {
    var legendItem = $('<span></span>').text( label['label'] + " ( " +label['value'].toLocaleString('es-MX') + " )" ).prepend('<br><span>&nbsp;</span>');
    legendItem.find('span')
      .css('backgroundColor', chartContainer3.options.colors[i])
      .css('width', '20px')
      .css('display', 'inline-block')
      .css('margin', '5px');
$('#legendGrafica').append(legendItem)
});

$('#totalArboles').text('Totales:' + totalArboles.toLocaleString('es-MX'));

/*var graficaBarrasArbolesTotales=Morris.Bar({
  element: 'graficaBarrasArbolesTotales',
  data: [
  
		 { y: 'Total: ' + totalArboles.toLocaleString('es-MX') ,entregados: totalArbolesEntregados, llevados: totalArboles ,diferencia:totalArboles-totalArbolesEntregados},								
  ],
  xkey: 'y',
  ykeys: ['entregados', 'diferencia'],
  labels: ['Entregados','Regresados'],
...
<script type="text/javascript">		
		...
		function initMap() 
		{
			...
			{						
				if($dia["VCH_LONGITUD"]!='' and $dia["VCH_LONGITUD"]!='')
				{
