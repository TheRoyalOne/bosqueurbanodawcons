...
<form action="<?=base_url().'index.php/reportes/GenerarReporteSupervivencia'?>" method="POST" target="_blank" id="form">
<div class="row form-horizontal">
  <div class="col-lg-6 col-md-6 col-sm-6">       
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-lg-8">
          <select class="form-control" id="VCH_ESTATUS" name="VCH_ESTATUS">             				
			...
			<option value="2">Vivo y Enfermo</option>							
      ...
      <div class="form-group">
        <label class="control-label col-lg-4">Mostrar Listado de QR:</label>
        <div class="col-lg-8">
