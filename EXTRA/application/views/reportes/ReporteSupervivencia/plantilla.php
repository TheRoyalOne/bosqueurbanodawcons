		...
		<table width="100%">
							...
							<td align="center">
								<table>
									...
									<tr>
										...
										<td>Estatus <b><?=$dataeventos["nombreestatus"]?></b></td>
									</tr>
									<tr>
										
										<td>Especie <b><?=$dataeventos["nombreespecie"]?></b></td>
										<td>Mostrar Listado <b><?=$dataeventos["ml"]?></b></td>
									</tr>
									<tr>										
										<td>Mostrar Fotos<b><?=$dataeventos["mf"]?></b></td>
									</tr>
								</table>
							</td>							 
						</tr>						
					  ...
					  <table width="70%" border=0>
						<tr>
							<td align="left" colspan="2"  class="bordersub">
								<b>Supervivencia Consulta</b>
							</td>						
							<td width="20px">
								<b><?=$dataeventos["supervivenciaConsulta"]?></b>
							</td>	 
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
			...
			<tr>
				<td  width="100%" align="center">
					  <table width="70%" border=0>
						...
						<tr>
							<td width="50px">&nbsp;</td>
							<td class="bordersub">Vivo</td>
							<td width="20px">
								<b><?=$dataeventos["supervivencia"]["vivosysanos"]+$dataeventos["supervivencia"]["vivosyenfermos"]?></b>
							</td>	 
						</tr>	
						<tr>
							<td width="50px">&nbsp;</td>
							<td colspan="2">
								<table width="100%">
									<tr>
										<td width="50px">&nbsp;</td>
										<td class="bordersub">Sano</td>
										<td width="20px">
											<b><?=$dataeventos["supervivencia"]["vivosysanos"]?></b>
										</td>	 
									</tr>
									<tr>
										<td width="50px">&nbsp;</td>
										<td class="bordersub">Enfermo</td>
										<td width="20px">
											<b><?=$dataeventos["supervivencia"]["vivosyenfermos"]?></b>
										</td>	 
									</tr>
								</table>
							</td>							
						...
						<tr>
							<td width="50px">&nbsp;</td>
							<td class="bordersub">Muerto</td>
							<td width="20px">
										<b><?=$dataeventos["supervivencia"]["muertos"]?></b>
							</td>	 
						</tr>					
					</table>					  
				</td> 
			...
			<tr>
				<td align="center">
					  <table width="70%" border=0>
						...
						<tr>
							<td width="50px">&nbsp;</td>
							<td class="bordersub">Permanece en bolsa</td>
							<td width="20px">
								<b><?=$dataeventos["condiciones"]["bolsa"]?></b>
							</td>	 
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
							<td class="bordersub">Plantado</td>
							<td>
								<b><?=$dataeventos["condiciones"]["PlantadoPrivadoLocalizado"]+$dataeventos["condiciones"]["PlantadoPrivadoTransportado"]+
									$dataeventos["condiciones"]["PlantadoPublicoLocalizado"]+$dataeventos["condiciones"]["PlantadoPublicoTransportado"]?></b>
							</td>	 
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
									...
									<tr>
										...
										<td colspan="2">
											<table width="100%">
												<tr>
													<td width="50px">&nbsp;</td>
													<td class="bordersub">Direccion Indicada</td>
													<td width="20px">
														<b><?=$dataeventos["condiciones"]["PlantadoPublicoLocalizado"]+$dataeventos["condiciones"]["PlantadoPrivadoLocalizado"]?></b>
													</td>	 
												</tr>
												<tr>
													<td width="50px">&nbsp;</td>
													<td class="bordersub">Otra direccion</td>
													<td width="20px">
														<b><?=$dataeventos["condiciones"]["PlantadoPublicoTransportado"]+$dataeventos["condiciones"]["PlantadoPrivadoTransportado"]?></b>
													</td>	 
												</tr>
											</table>
										</td>							
									...
									<tr>
										...
										<td colspan="2">
											<table width="100%">
												<tr>
													<td width="50px">&nbsp;</td>
													<td class="bordersub">Propiedad Privada</td>
													<td width="20px">
														<b><?=$dataeventos["condiciones"]["PlantadoPrivadoLocalizado"]+$dataeventos["condiciones"]["PlantadoPrivadoTransportado"]?></b>
													</td>	 
												</tr>
												<tr>
													<td width="50px">&nbsp;</td>
													<td class="bordersub">Via publica</td>
													<td width="20px">
													<b><?=$dataeventos["condiciones"]["PlantadoPublicoLocalizado"]+$dataeventos["condiciones"]["PlantadoPublicoTransportado"]?></b>
													</td>	 
												</tr>
											</table>
										</td>							
			 ...
			 <tr>
				<td width="100%" align="center">
					  <table width="70%" border=0>
						...
						<tr>
							<td width="50px">&nbsp;</td>
							<td class="bordersub">Tiene la etiqueta</td>
							<td width="20px">
								<b><?=$dataeventos["ConEtiqueta"]["si"]?></b>
							</td>	 
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
							<td class="bordersub">Etiqueta Removida</td>
							<td width="20px">
								<b><?=$dataeventos["ConEtiqueta"]["no"]?></b>
							</td>	 
						</tr>
					</table>					  
				</td> 
			...
			<tr>
				<td width="100%" align="center">
					  <table width="70%" border=0>
						<tr>
							<td align="left" colspan="5" class="bordersub">
								<b>Supervivencia por especie</b>
							</td>	
																				
						</tr>
						<tr>
							<td width="40%">&nbsp;</td>
							<td colspan="2" align="center" width="15%">Vivo</td>
							<td colspan="2" align="center" width="15%">Muerto</td>
						...
						$totalV=0;
						$totalM=0;
						foreach($dataeventos["SupervivenciaEspecie"] as $row) 
						{						
							$total++;
							if($row["V"]+$row["M"]>0)							
							{
								$porcentajeV=number_format((($row["V"]/($row["V"]+$row["M"]))*100),2);
							}
							else
							{
								$porcentajeV=0;
							...
							if($row["V"]+$row["M"]>0)							
							{
								$porcentajeM=number_format((($row["M"]/($row["V"]+$row["M"]))*100),2);							
							}
							else
							{
								$porcentajeM=0;
						...
						<tr>
							...
							<td align="right" width="10%"><?=$porcentajeV?>%</td>
							<td align="center"><?=$row["V"]?></td>														
							
							<td align="right" width="10%"><?=$porcentajeM?>%</td>
							<td align="center"><?=$row["M"]?></td>														
							
							<td align="center"><?=$row["V"]+$row["M"]?></td>
						</tr>																	
						<?php
								$totalV+=$row["V"];
								$totalM+=$row["M"];
						...
						<tr>
							<td align="center" >&nbsp;</td>						
							<td align="center" width="20%" colspan="2"><b><?=@number_format($totalV/($totalV+$totalM)*100,2)?>%</b></td>																			
							<td align="center" width="20%" colspan="2"><b><?=@number_format($totalM/($totalV+$totalM)*100,2)?>%</b></td>							
							<td  align="center" ><?=$totalV+$totalM?></td>
						</tr>																						
					</table>					  
				</td> 
			</tr>			
			...
			<tr>
				<td width="100%" align="center">
					<!-- DISPLAY NONE -->
					<table width="70%" border=0 style="display: none;">
						<tr>
							<td align="left" colspan="5" class="bordersub" >
								<b>Supervivencia por Patrocinador</b>
							</td>	
						...
						<tr>
							<td width="40%">&nbsp;</td>
							<td colspan="2" align="center" width="20%">Vivo</td>
							<td colspan="2" align="center" width="20%">Muerto</td>
						...
						$totalV=0;
						$totalM=0;
						foreach($dataeventos["SupervivenciaPatrocinador"] as $row) 
						{						
//							die(print_r(($row)));
							$total++;
							@$porcentajeV=number_format((($row["V"]/($row["V"]+$row["M"]))*100),2);
			...
			<tr>
				<td align="center">
					  <table width="70%" border=0>
						<tr>
							<td align="center" colspan="2"  valign="bottom" style="font-size:24px">
								<b>Estatus del árbol</b>
							</td>						
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
			...
			<tr>
				<td align="center">
					  <table width="70%" border=0>
						<tr>
							<td align="center" colspan="2"  valign="bottom" style="font-size:24px">
								<b>¿Esta en la ubicacion proporcionada?</b>
							</td>						
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
			...
			<tr>
				<td align="center">
					  <table width="70%" border=0>
						<tr>
							<td align="center" colspan="2"  valign="bottom" style="font-size:24px">
								<b>¿Conserva la etiqueta QR?</b>
							</td>						
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
							<td>
								<div id="chartContainer5" style="height: 300px; width: 90%;"></div>
				...
				<td align="center">
					  <table width="70%" border=0>
						...
						<tr>
							<td width="50px">&nbsp;</td>
							<td>
								<div id="chartContainer6" style="height: 500px; width: 90%;"></div>
							</td>	 
						</tr>									
					</table>					  
				</td> 
				...
				<td align="center">
					...
					<table width="70%" border=0 style="display: none;">
						...
						<tr>
							<td width="50px">&nbsp;</td>
							<td>
								<div id="chartContainer7" style="height: 600px; width: 90%;"></div>
							</td>	 
						</tr>									
					</table>					  
				</td> 
			...
			<tr>
				<td width="100%" align="center">
					  <table border="1" width="100%">
						...
						foreach($dataeventos["mldata"] as $data)
						{
						?>
						<tr>
							<td align="center"><?=$data["codigo"]?> </td>
							<td align="center"><?=$data["especie"]?></td>
							<td align="center"><?=$data["guardabosques"]?></td>
							<td align="center"><?php if($data["estado"]=="V"){echo "Vivo";}else{echo "Muerto";}?></td>
							<td align="center"><?php if($data["salud"]=="S"){echo "Sano";}else{echo "Enfermo";}?></td>
						</tr>
						<?php
						}
						?>
			...
			<tr>
				<td width="100%" align="center">
					  <table border="1" width="100%">
						...
						<?php
						foreach($dataeventos["mfdata"] as $data)
						{
						?>
						<tr>
							<td align="center"><?=$data["codigo"]?> </br> <?=$data["especie"]?> </br><?=$data["guardabosques"]?></td>
							<td align="center"> 
								
							<?php
								//echo base_url()."uploads/seguimiento/".$data["codigo"]."/".$data["VCH_RUTA_FOTO_COMPLETA"];
								//echo base_url()."uploads/seguimiento/".$data["codigo"]."/".str_replace ( " ", "_" , $data["VCH_RUTA_FOTO_COMPLETA"]);
								
								if(true)
								//if(file_exists ("C://xampp//htdocs//Extra//uploads/seguimiento/".$data["codigo"]."//".$data["VCH_RUTA_FOTO_COMPLETA"]))
							{
							?>								

								<img src="<?= base_url();?>uploads/seguimiento/<?=$data["codigo"]?>/<?=str_replace(' ','_',$data["VCH_RUTA_FOTO_COMPLETA"])?>"  style="max-width:150px; max-height:200px" >
								<?php
							}
							?>
							</td><!--arbol-->
							<td align="center"> 
							<?php
								//if(file_exists ("C://xampp//htdocs//Extra//uploads/seguimiento/".$data["codigo"]."//".$data["VCH_RUTA_FOTO_SOLOETIQUETA"]))
							if(true)
								{
							?>
							
								<img src="<?= base_url();?>uploads/seguimiento/<?=$data["codigo"]?>/<?=str_replace(' ','_',$data["VCH_RUTA_FOTO_SOLOETIQUETA"])?>" style="max-width:357px; max-height:200px"> 
							<?php
								}
							?>
							</td><!--qr-->							
...
<script type="text/javascript">
 ...
 function graph()
{
		var chartContainer=Morris.Donut({
		  element: 'chartContainer',
		  data: [		  
				{label: "Vivos <?=round((($dataeventos["supervivencia"]["vivosysanos"]+$dataeventos["supervivencia"]["vivosyenfermos"])/($dataeventos["supervivencia"]["vivosysanos"]+$dataeventos["supervivencia"]["vivosyenfermos"]+$dataeventos["supervivencia"]["muertos"])*100),2)?>%", value: <?=($dataeventos["supervivencia"]["vivosysanos"]+$dataeventos["supervivencia"]["vivosyenfermos"])?>},							
				{label: "Muertos <?=round((($dataeventos["supervivencia"]["muertos"])/($dataeventos["supervivencia"]["vivosysanos"]+$dataeventos["supervivencia"]["vivosyenfermos"]+$dataeventos["supervivencia"]["muertos"])*100),2)?>%", value: <?=$dataeventos["supervivencia"]["muertos"]?>},							
		  ], colors: 
		  [
			'#269B09',
			'#B26D1C',
		...
		chartContainer.options.data.forEach(function(label, i) {
			var legendItem = $('<span></span>').text( label['label'] + " ( " +label['value'] + " )" ).prepend('<br><span>&nbsp;</span>');
			legendItem.find('span')
			  .css('backgroundColor', chartContainer.options.colors[i])
			  .css('width', '20px')
...
{				
	<?php
		$plantado=$dataeventos["condiciones"]["PlantadoPrivadoLocalizado"]+$dataeventos["condiciones"]["PlantadoPrivadoTransportado"]+$dataeventos["condiciones"]["PlantadoPublicoLocalizado"]+$dataeventos["condiciones"]["PlantadoPublicoTransportado"];
		$total=$plantado+$dataeventos["condiciones"]["bolsa"];

	?>
	var chartContainer2=Morris.Donut({
		  element: 'chartContainer2',
		  data: [		  
				{label: "Plantado <?=round(($plantado/$total),2)*100 ?>%", value: <?=$plantado?>},							
				{label: "En bolsa <?=round(($dataeventos["condiciones"]["bolsa"]/$total),2)*100 ?>%", value: <?=$dataeventos["condiciones"]["bolsa"]?>},							
		  ], colors: 
		  [
			'#269B09',
			'#B26D1C',
...
{				
	<?php
	$localizado=$dataeventos["condiciones"]["PlantadoPublicoLocalizado"]+$dataeventos["condiciones"]["PlantadoPrivadoLocalizado"];
	$otradireccion=$dataeventos["condiciones"]["PlantadoPublicoTransportado"]+$dataeventos["condiciones"]["PlantadoPrivadoTransportado"];
	$total=$localizado+$otradireccion;
	?>
	var chartContainer3=Morris.Donut({
		  element: 'chartContainer3',
		  data: [		  
				{label: "Direccion Indicada <?=round(($localizado/$total),2)*100 ?>%", value: <?=$localizado?>},
					{label: "Otra direccion <?=round(($otradireccion/$total),2)*100 ?>%", value: <?=$otradireccion?>},							
			   ], colors: 
		  [
			'#269B09',
			'#B26D1C',
...
{				
	<?php
$publico=$dataeventos["condiciones"]["PlantadoPublicoLocalizado"]+$dataeventos["condiciones"]["PlantadoPublicoTransportado"];
$privado=$dataeventos["condiciones"]["PlantadoPrivadoLocalizado"]+$dataeventos["condiciones"]["PlantadoPrivadoTransportado"];
$total=$publico+$privado;



	?>
	var chartContainer4=Morris.Donut({
		  element: 'chartContainer4',
		  data: [		  
				{label: "Via publica <?=round(($publico/$total),2)*100 ?>%", value: <?=$publico?>},							
						{label: "Propiedad Privada <?=round(($privado/$total),2)*100 ?>%", value: <?=$privado?>},							
				   ], colors: 
		  [
			'#269B09',
			'#B26D1C',
		...
		chartContainer4.options.data.forEach(function(label, i) {
			var legendItem = $('<span></span>').text( label['label'] + " ( " +label['value'] + " )" ).prepend('<br><span>&nbsp;</span>');
			legendItem.find('span')
			  .css('backgroundColor', chartContainer4.options.colors[i])
			  .css('width', '20px')
			  .css('display', 'inline-block')
			  .css('margin', '5px');
...
{				
	<?php
			$si=$dataeventos["ConEtiqueta"]["si"];
			$no=$dataeventos["ConEtiqueta"]["no"];
			$total=$si+$no;
	?>
	var chartContainer5=Morris.Donut({
		  element: 'chartContainer5',
		  data: [		  
				{label: "Si <?=round(($si/$total),2)*100 ?>%", value: <?=$dataeventos["ConEtiqueta"]["si"]?>},							
				{label: "No <?=round(($no/$total),2)*100 ?>%", value: <?=$dataeventos["ConEtiqueta"]["no"]?>},							
				   ], colors: 
		  [
			'#269B09',
			'#B26D1C',
		...
		chartContainer5.options.data.forEach(function(label, i) {
			var legendItem = $('<span></span>').text( label['label'] + " ( " +label['value'] + " )" ).prepend('<br><span>&nbsp;</span>');
			legendItem.find('span')
			  .css('backgroundColor', chartContainer5.options.colors[i])
			  .css('width', '20px')
			  .css('display', 'inline-block')
			  .css('margin', '5px');
...
function graph6()//barras
{	

  var chartContainer6=Morris.Bar({
  element: 'chartContainer6',
  data: [  
     <?php	foreach($dataeventos["SupervivenciaEspecie"] as $dia)
     {
     	
     	$vivos=intval($dia["V"]);
     	$muertos=intval($dia["M"]);
     	$total=$vivos+$muertos;
//		die(print_r($dia)); 
		   ?>		
		 { y: '<?=$dia["NOMBRE"]?> - <?=round(($vivos/$total),2)*100 ?>%',Vivos: <?=intval($dia["V"])?>, Muertos: <?=intval($dia["M"])?>,diferencia:<?=intval($dia["V"])-intval($dia["M"])?> },					
	...
	chartContainer6.options.data.forEach(function(label, i) 
	{
		var	elemento=''+
			'<div>'+
				'<label><b>'+label["y"]+'</b></label>'+
				'<span style="width:20px;background-Color:'+chartContainer6.options.barColors[0]+';display:inline;margin:5px;">&nbsp;&nbsp&nbsp</span>Vivos: '+label["Vivos"]+''+
				'<span style="width:20px;background-Color:'+chartContainer6.options.barColors[1]+';display:inline;margin:5px;">&nbsp;&nbsp&nbsp</span>Muertos: '+label["Muertos"]+''+
			'</div>';
		$('#legend6').append(elemento);
	});
	
}

function graph7()//barras
{	
  var chartContainer7=Morris.Bar({
  element: 'chartContainer7',
  data: [  
     <?php	foreach($dataeventos["SupervivenciaPatrocinador"] as $dia)
     {
     	$vivos=intval($dia["V"]);
     	$muertos=intval($dia["M"]);
     	$total=$vivos+$muertos;
	...
	chartContainer7.options.data.forEach(function(label, i) 
	{
		var	elemento=''+
			'<div>'+
				'<label><b>'+label["y"]+'</b></label>'+
				'<span style="width:20px;background-Color:'+chartContainer7.options.barColors[0]+';display:inline;margin:5px;">&nbsp;&nbsp&nbsp</span>Vivos: '+label["Vivos"]+''+
				'<span style="width:20px;background-Color:'+chartContainer7.options.barColors[1]+';display:inline;margin:5px;">&nbsp;&nbsp&nbsp</span>Muertos: '+label["Muertos"]+''+
			'</div>';
		$('#legend7').append(elemento);
	});
	
}
		/*
		function grafpastel2()
		{
			var chartContainer3=Morris.Donut({
			  element: 'chartContainer3',
			  data: [
			  
					{label: "Direccion Indicada", value: <?=$dataeventos["condiciones"]["PlantadoPublicoLocalizado"]+$dataeventos["condiciones"]["PlantadoPrivadoLocalizado"]?>},							
					{label: "Otra direccion", value: <?=$dataeventos["condiciones"]["PlantadoPublicoTransportado"]+$dataeventos["condiciones"]["PlantadoPrivadoTransportado"]?>},							
			  ], colors: 
			  [
				'#E87B2F',
				'#4270C1',
		...
		function grafbarras2()
		{
				var chartContainer4=Morris.Donut({
				  element: 'chartContainer4',
				  data: [
				  
						{label: "Via publica", value: <?=$dataeventos["condiciones"]["PlantadoPublicoLocalizado"]+$dataeventos["condiciones"]["PlantadoPublicoTransportado"]?>},							
						{label: "Propiedad Privada", value: <?=$dataeventos["condiciones"]["PlantadoPrivadoLocalizado"]+$dataeventos["condiciones"]["PlantadoPrivadoTransportado"]?>},							
				  ], colors: 
				  [
					'#E87B2F',
					'#4270C1',
