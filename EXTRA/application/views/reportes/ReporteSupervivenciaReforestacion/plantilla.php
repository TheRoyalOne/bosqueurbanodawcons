<?
		var bgs=["#50A45E",#5DA450,#73A450,#86A450,#95A450,#95A450]	
?>
<html>
	<head>
		<style>		
		...
		<table width="100%">
					  ...
					  <table width="100%">
						<tr>
							<td align="center" style="font-size:18px">
									<b>Supervivencia - Eventos de reforestacion</b>
							</td>							 
						</tr>
						<tr>
							<td>&nbsp;</td>
						...
						<tr>
							<td align="center">
								<table>
									<tr>
										<td colspan="2">Periodo Del <b><?=$del?></b> Al <b><?=$al?></b> </td>										
									</tr>
									<tr>
										<td>Patrocinador <b><?=$dataeventos["nombreempresa"]?></b></td>
										<td>Reforestacion <b> <?=$dataeventos["nombreevento"]?></b></td>
									</tr>
									<tr>
				...
				<td width="100%" align="center">
					  <table width="70%" border=0>
						<tr>
							...
							<td width="20px">
								<b><?=$dataeventos["cantidadEventos"]?></b>
							</td>	 
						</tr>
			...
			<tr>
				<td  width="100%" align="center">
					  <table width="70%" border=0>
						<tr>												
							<td align="left" colspan="2"  >
								<b>Arboles Plantados</b>
							</td>						
							<td width="20px">
								<?php								
									//die(print_r($dataeventos["supervivencia"]));
								?>
								<b><?=$dataeventos["supervivencia"][0]["NUM_VIVOS"]+$dataeventos["supervivencia"][0]["NUM_MUERTOS"]?></b>
							</td>	
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
							...
							<td width="20px">
								...
								<b><?=($dataeventos["supervivencia"][0]["NUM_VIVOS"])?></b>
							</td>	 
						</tr>	
						<tr>
							<td width="50px">&nbsp;</td>
							<td colspan="2">
								<table width="100%">
									<tr>
										...
										<td width="20px">
											<b><?=$dataeventos["supervivencia"][0]["NUM_SANOS"]?></b>
										</td>	 
									</tr>
									<tr>
										<td width="50px">&nbsp;</td>
										...
										<td width="20px">
											<b><?=$dataeventos["supervivencia"][0]["NUM_ENFERMOS"]?></b>
										</td>	 
									</tr>
								</table>
							</td>							
						...
						<tr>
							...
							<td width="20px">
										<b><?=$dataeventos["supervivencia"][0]["NUM_MUERTOS"]?></b>
							</td>	 
						</tr>					
					</table>					  
				</td> 
			...
			<tr>
				<td width="100%" align="center">
					  <table width="70%" border=0>
						<tr>
							<td align="left"  class="bordersub">
								<b>Supervivencia por especie</b>
							</td>			
							<td align="center" width="20%">Plantados</td>
						...
						{						
							...
							@$porcentajeV=number_format((($row["NUM_VIVOS"]/($row["NUM_VIVOS"]+$row["NUM_MUERTOS"]))*100),2);
							@$porcentajeM=number_format((($row["NUM_MUERTOS"]/($row["NUM_VIVOS"]+$row["NUM_MUERTOS"]))*100),2);							
						?>
						<tr>
							<td align="center" ><?=$row["VCH_NOMBRECOMUN"]?></td>
							<td align="center"><?=$row["NUM_VIVOS"]+$row["NUM_MUERTOS"]?></td>
							<td align="right" width="10%"><?=$porcentajeV?>%</td>
							<td align="center"><?=$row["NUM_VIVOS"]?></td>														
							
							<td align="right" width="10%"><?=$porcentajeM?>%</td>
							<td align="center"><?=$row["NUM_MUERTOS"]?></td>														
							
							
						</tr>																	
						<?php
								$totalV+=$row["NUM_VIVOS"];
								$totalM+=$row["NUM_MUERTOS"];
								$total++;
						}?>
						<tr>
							<td>&nbsp;</td>
			...
			<tr>
				<td width="100%" align="center">
					  <table width="70%" border=0>
						<tr>
							<td align="left" class="bordersub" >
								<b>Supervivencia por Evento de Reforestacion</b>
							</td>								
							<td align="center" width="20%">Plantados</td>	
							<td colspan="2" align="center" width="20%">Vivo</td>
							<td colspan="2" align="center" width="20%">Muerto</td>
						...
						$totalV=0;
						$totalM=0;
						foreach($dataeventos["supervivenciaPorEvento"] as $row) 
						{						
//							die(print_r(($row)));
							$total++;
							$porcentajeV=number_format((($row["NUM_VIVOS"]/($row["NUM_VIVOS"]+$row["NUM_MUERTOS"]))*100),2);
			...
			<tr>
				<td align="center">
					  <table width="70%" border=0>
						<tr>
							<td align="center" colspan="2"  valign="bottom" style="font-size:24px">
								<b>Supervivencia por Patrocinadores</b>
							</td>						
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
			...
			<tfoot>
				  <tr>
					  <td>
						  <table width="100%">
							<tr>
								<td>Reporte Supervivencia Reforesta</td>
 ...
 function graph()
{
	...
	{
	  ?>	
		{ y: '<?=$row["VCH_NOMBRECOMUN"]?>', a:<?=$row["NUM_VIVOS"]?>, b: <?=$row["NUM_MUERTOS"]?> },	
	<?php 
	} 
	?>
	  ],
	  xkey: 'y',
	  ykeys: ['a', 'b'],
	  labels: ['Vivos', 'Muertos'], barColors: [
    '#00AD00','#805A0A'
  ],barGap:0.2,
  barSizeRatio:0.4
	});		
