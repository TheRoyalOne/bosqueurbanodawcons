...
<form action="<?=base_url().'index.php/reportes/GenerarReporteTALLER'?>" method="POST" target="_blank" id="form">
  ...
  <div class="col-lg-6 col-md-6 col-sm-6">       
    <div class="form-group">
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        <label class="control-label col-lg-4">Tipo de taller:</label>
        <div class="col-lg-8">
         <select class="form-control" id="ID__TALLER" name="ID__TALLER">
		 <option value="-1">Todos</option>
          <?php          
			foreach($tipostaller as $tipotaller)
			{?>     				
				<option value="<?=$tipotaller["ID__TALLER"]?>"><?=$tipotaller["VCH_NOMBRE"]?></option>				
			<?php
			}
			?>
        </select>
