<html>
	<head>
		...
		<?php
			function diasemanahumana($valor)
			{
					  ...
					  <table width="100%">
						<tr>
							<td align="center" style="font-size:18px">
									<b>Reporte Eventos de Reforestacion</b>
							</td>							 
						</tr>
						<tr>
							<td>&nbsp;</td>
			...
			<tr>
				<td align="center">
					  <table width="70%" border=0>
						<tr>
							<td align="left" colspan="2" class="bordersub" >
								<b>Reforestaciones por patrocinador</b>
							</td>													
						</tr>
						<?php 						
						foreach($dataeventos["reforestacionesPorPatrocinador"] as $pat)
						{
						?>
						<tr>
							<td width="50px">&nbsp;</td>
							<td class="bordersub"><?=$pat["nombre"]?></td>
							<td width="20px">
								<b><?=$pat["apariciones"]?></b>
							</td>	 
						</tr>						
			...
			<tr>
				<td align="center">
					  <table width="70%" border=0>
						<tr>
							<td align="left" colspan="2"  class="bordersub">
								<b>Reforestaciones por tipo</b>
							</td>						
							
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
							<td class="bordersub">Empresarial</td>
							<td width="20px">
								<b><?=$dataeventos["totalEventosPortipo"]["empresarial"]?></b>
							</td>	 
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
							<td class="bordersub">Masivo</td>
							<td>
								<b><?=$dataeventos["totalEventosPortipo"]["masivo"]?></b>
							</td>	 
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
							<td class="bordersub">Ambas</td>
							<td>
								<?php
//								 echo "<pre>";						die(print_r($dataeventos["totalEventosPortipo"])); ?>
								<b><?=$dataeventos["totalEventosPortipo"]["ambas"]?></b>
							</td>	 
						</tr>						
						<tr>
							<td width="50px">&nbsp;</td>
							<td class="bordersub">Taller</td>
							<td>
								<b><?=$dataeventos["totalEventosPortipo"]["taller"]?></b>
							</td>	 
						</tr>						
					</table>					  
				</td> 
			...
			<tr>
				<td align="center">
					  <table width="70%" border=0>
						<tr>
							<td align="left" colspan="2" class="bordersub">
								<b>Reforestaciones por Arbolado</b>
							</td>						
							<td width="20px">
							<?php
							$conteo=0;
							foreach($dataeventos["totalReforestacionesPorEspecie"] as $dia)
							{
								$conteo+=$dia["NUM_CANTIDAD"];
							}
							echo $conteo;
							?>
						...
						<tr>
							<td width="50px">&nbsp;</td>
							<td class="bordersub"><?=$dia["VCH_NOMBRECOMUN"];?></td>
							<td width="20px">
								<b><?=$dia["NUM_CANTIDAD"]?></b>
							</td>	 
						</tr>					
						<?php
						}?>																
				...
				<td align="center">
					  <table width="70%" border=0>
						...
						<tr>
							...
							<td align="left" colspan="2" class="bordersub">
								<b>Reforestaciones por evento - arbolado</b>
							</td>						
							<td width="20px">
							
						<?php 
						$cont=0;
						foreach($dataeventos["totalReforestacionesPorEventoArbolado"] as $dia)
						{	
							$cont+=$dia["NUM_CANTIDAD"];							
						}
							echo "<b>".$cont."</b>";
						?>
							</td>
						...
						foreach($dataeventos["totalReforestacionesPorEventoArbolado"] as $dia)						
						{
							...
							if($idactual!=$dia["ID__EVENTO"])
							{
								$idactual=$dia["ID__EVENTO"];
						?>
						<tr>
							<td width="50px">&nbsp;</td>
							<td><?=$dia["VCH_NOMBREEVENTO"]." ".substr($dia["FEC_FECHAINICIO"],0,10)?> </td>
							<td width="20px">
								<b>
									<?php 
									$cont=0;
									foreach($dataeventos["totalReforestacionesPorEventoArbolado"] as $inner)						
									{
										if($dia["ID__EVENTO"]==$inner["ID__EVENTO"])
										{
											$cont+=$inner["NUM_CANTIDAD"];
										}
									}
									echo $cont;
									?>
					  ...
					  <table width="70%" border=0>
						<tr>
							<td align="left" colspan="2" >
								<b>Reforestaciones Convocados y Asistentes</b>
							</td>						
							<td>Convoca <br/> 1350 </td>
							<td>Asiste <br/> 1350 </td>
							<td>Eficiente <br/> 135% </td>
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
							<td>Reforestacion Metropolitano 15/07/2017</td>
							<td>
								<b>100</b>
							</td>	 
							<td>
					  ...
					  <table width="70%" border=0>
						<tr>
							<td align="center" colspan="2"  valign="bottom" style="font-size:24px">
								<b>Evento de Reforestacion - Por día</b>
							</td>						
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
			...
			<tr>
				<td align="center">
					  <table width="70%" border=0>
						<tr>
							<td align="center" colspan="2"  valign="bottom" style="font-size:24px">
								<b>Eventos de Reforestacion - Patrocinador</b>
							</td>						
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
			...
			<tr>
				<td align="center">
					  <table width="70%" border=0>
						<tr>
							<td align="center" colspan="2"  valign="bottom" style="font-size:24px">
								<b>Eventos de Reforestacion - Tipo de reforestacion</b>
							</td>						
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
			...
			<tr>
				<td align="center">
					  <table width="70%" border=0>
						<tr>
							<td align="center" colspan="2"  valign="bottom" style="font-size:24px">
								<b>Eventos de Reforestacion - Especies</b>
							</td>						
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
					  ...
					  <table width="70%" border=0>
						<tr>
							<td align="left" colspan="2"  valign="bottom">
								<b>Eventos de Reforestacion - Convocado & Asistentes</b>
							</td>						
						</tr>
						<tr>
							<td width="50px">&nbsp;</td>
		...
		<script>
			...
			var chartContainer2=Morris.Donut({
			  ...
			  <?php 						
						...
						{label: "<?=$pat["nombre"]?>", value: <?=$pat["apariciones"]?>},
						<?php
						}?>			  				
			  ], colors: [
				'#E87B2F',
		...
		$('#legend2').append(legendItem)
			...
			var chartContainer3=Morris.Donut({
			  ...
			  data: [			  			 
						...
						{label: "Masivo", value: <?=$dataeventos["totalEventosPortipo"]["masivo"]?>},							  				
						{label: "Empresarial Cerrado", value: <?=$dataeventos["totalEventosPortipo"]["empresarial"]?>},							  				
						{label: "Taller", value: <?=$dataeventos["totalEventosPortipo"]["taller"]?>},							  				
						{label: "Empresarial Abierto", value: <?=$dataeventos["totalEventosPortipo"]["ambas"]?>}							  				
		...
		$('#legend3').append(legendItem)
			...
			var chartContainer4=Morris.Donut({
			  ...
			  data: [			  			 
						/*{label: "Empresarial", value: <?=$dataeventos["totalEventosPortipo"]["empresarial"]?>},							  				
						{label: "Masivo", value: <?=$dataeventos["totalEventosPortipo"]["masivo"]?>},							  				
						{label: "Ambas", value: <?=$dataeventos["totalEventosPortipo"]["ambas"]?>},							  				
						{label: "Taller", value: <?=$dataeventos["totalEventosPortipo"]["taller"]?>}							  				*/
						<?php 						
						foreach($dataeventos["GRAFTOTALARBOLADO"] as $pat)
						{
						
						?>						
							{label: "<?=$pat["VCH_NOMBREEVENTO"]?>", value: "<?=$pat["CANT"]?>"},
						<?php
						}?>		
